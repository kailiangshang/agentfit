#!/usr/bin/env python3
"""Validate the AgentFit fusion-v3 alternative deck deliverables."""
...
EXPECTED_PAGE_TITLES = (
    ...
    "AgentTeams 提供 Worker、Team、Room、Human、Dossier 与 Trace。",
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Validate AgentFit fusion-v3 PPTX and optional PDF."
    )
