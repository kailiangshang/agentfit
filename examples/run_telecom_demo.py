...
from agentfit.models.config import AutoApprove, TrainingConfig # noqa: E402
...
def main() -> None:
    ...
    orch = Orchestrator(initial, SamplePool(samples), executor,
    ...
    final = outcomes[-1]
    print(f"\n最终: 通过率 {final.pass_rate:.0%} · 候选快照 {orch.solution.version}"
