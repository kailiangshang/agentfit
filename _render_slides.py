"""Render 12 slides to PNG for visual review."""
from pathlib import Path
from playwright.sync_api import sync_playwright

SLIDES_DIR = Path("competition/2026-08-15/submission/slides")
OUT_DIR = Path("competition/2026-08-15/submission/_screenshots")
