...
本目录只保留一个当前整体方案。内部证据、契约和评分材料用于支撑该方案，不构成其他方案版本；归档材料只用于追溯。
...
任何与本文件冲突的历史讨论、旧方法论或执行计划均不具备当前规范地位。
...
- [设计讨论归档说明](archive/design-history/README.md)
- `archive/superseded-design/`：被唯一方案取代的旧方法论和执行设计
- `archive/superseded-plans/`：已经执行或失效的路线图与阶段计划
- `archive/execution-plans/`：仓库治理等已批准执行计划

归档文件不能作为正式实现输入，也不能覆盖 [AgentFit 整体方案](agentfit-solution.md)中的当前定义、完成状态和证据边界。
